...
const SwapCard = ({ product, isGrid = false, onPress }: SwapCardProps) => {
    ...
    >
      <View className="flex-1">
        ...
        <View className="p-4 bg-white rounded-t-[20px] -mt-5 relative">
          ...
          <View 
            className="w-full h-10 rounded-xl border border-slate-200 items-center justify-center bg-slate-50"
          >
